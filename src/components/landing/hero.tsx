        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          <div className="space-y-8 animate-fade-in">
            ...
            <p className="text-lg sm:text-xl text-gray-400 leading-relaxed max-w-xl">
              Müşterileriniz masadan ya da onlineden siparişini verir, ödemeyi işletmenizin kendi sanalposuna yapar. Mutfak otomatik bildirim alır, fiş ve adisyon kendiliğinden çıkar.
            </p>
