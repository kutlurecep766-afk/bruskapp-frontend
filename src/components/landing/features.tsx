const features = [
  ...
  { icon: '📱', title: '5 Platform Entegrasyon', desc: 'Instagram, WhatsApp, Messenger, Telegram ve Web Chat tek panelden.' },
  ...
  { icon: '📢', title: 'QR Menü & Masa Sipariş', desc: 'QR kod ile dijital menü, müşteri masadan doğrudan özel sipariş verebilir, garson çağırmaya gerek kalmaz.' },
    ...
    <section id="özellikler" className="relative py-24 lg:py-32">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400 text-lg mt-4 max-w-2xl mx-auto">          5 platformda chatbot, bilgi havuzu, CRM, QR menü, masa sipariş ve analiz tek panelde</p>
        </div>
